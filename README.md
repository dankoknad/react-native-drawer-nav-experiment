...
This is an (personal) exploration of the [react-navigation](https://reactnavigation.org/) package and the [DrawerNavigator](https://reactnavigation.org/docs/navigators/drawer). 
